...
public class WorkspaceController {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(name = "워크스페이스 생성 성공",
                                    value = "{\"success\": true, \"data\": 1, \"meta\": {\"timestamp\": \"2026-03-24T19:36:08.117\", \"traceId\": \"ws-create-1234\"}}")))
    })
    @PostMapping
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(name = "목록 조회 성공",
                                    value = "{\"success\": true, \"totalCount\": 1, \"nextCursor\": 0, \"data\": [{\"userId\": 2, \"name\": \"둘리\", \"email\": \"user@example.com\", \"role\": \"ADMIN\"}], \"meta\": {\"timestamp\": \"2026-03-24T19:36:08.117\"}}")))
    })
    ...
    public ResponseEntity<ApiListResponse<WorkspaceMemberResponseDto>> getMembers(
        ...
        List<WorkspaceMemberResponseDto> list = workspaceService.getWorkspaceMembers(workspaceId, status);
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(name = "초대 목록 조회 성공",
                                    value = "{\"success\": true, \"totalCount\": 1, \"nextCursor\": 0, \"data\": [{\"workspaceId\": 3, \"workspaceName\": \"캡스톤팀\", \"color\": \"BLUE\"}]}")))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(name = "내 워크스페이스 목록 조회 성공",
                                    value = "{\"success\": true, \"totalCount\": 1, \"nextCursor\": 0, \"data\": [{\"workspaceId\": 1, \"workspaceName\": \"팀플\", \"color\": \"BLUE\"}]}")))
    })
    @GetMapping("/my")
